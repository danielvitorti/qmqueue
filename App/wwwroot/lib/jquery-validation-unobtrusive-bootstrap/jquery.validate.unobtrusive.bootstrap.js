...
(function ($) {
    ...
    function onSuccess(successBase, error, inputElement) {
        successBase(error);

        if (!$(inputElement).hasClass('input-validation-error')) {
            addSuccessClass(inputElement)
        }
    }
    ...
    $.fn.validateBootstrap = function (refresh) {
        return this.each(function () {
            ...
            if (validator) {
                ...
                validator.settings.success = function (error, inputElement) {
                    onSuccess(successBase, error, inputElement);
                }
